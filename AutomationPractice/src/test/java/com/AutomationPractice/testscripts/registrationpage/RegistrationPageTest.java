...
//		// TestBase.logExtentReport(errorMessage);
...
//		registrationPage.setDay("20");
//		registrationPage.setMonth("July");
//		registrationPage.setYear("2019");
...
//		registrationPage.setYourAddressCountry("United States");
//		registrationPage.setAdditionalInformation("This is for testing automation purposes");
...
//		boolean status = myAccountPage.isMyAccountMessage();
//
//		AssertionHelper.updateTestStatus(status);
...
//	}
	...
	public void registerUsersFromDataFile(String firstname, String lastname, String password, String address1, String city, String zipcode, String country, String phone) {
		// Navigate to URL
		getApplicationUrl(ObjectReader.reader.getUrl());
		navigationMenu = new NavigationMenu(driver);
		// Navigate to sign in page
